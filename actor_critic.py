...
class Actor(nn.Module):
    def __init__(self, obs_dim, act_dim):
        ...
        self.hl1 = nn.Linear(self.obs_dim, HIDDEN_SIZE)
        # hidden layer 2 128 x 64, compress actions
        self.hl2 = nn.Linear(HIDDEN_SIZE, 64)
    ...
    def forward(self, obs):
        ...
        '''
        obs = Functional.relu(self.hl1(obs))
        obs = Functional.relu(self.hl2(obs))
...
class Critic(nn.Module):
    ...
    def forward(self, obs):
        '''
            ...
            Uses our 2 hidden layers: hl1 and hl2
        ...
        obs = torch.relu(self.hl1(obs))
        obs = torch.relu(self.hl2(obs))
